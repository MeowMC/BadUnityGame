...
public class StrafeMovement : MonoBehaviour
{
    ...
    [SerializeField]
    public float airAccel = 42f;      // How fast the player accelerates in the air
    [SerializeField]
	...
	public void Update()
    {
        PlayerCharacterController PCC = new PlayerCharacterController();
        lastJumpPress = PCC.m_LastTimeJumped;
	...
	public Vector3 CalculateMovement(Vector2 input, Vector3 velocity)
	{
        ...
        Vector3 camRotation = new Vector3(0f, PCC.playerCamera.transform.rotation.eulerAngles.y, 0f);
	...
	public Vector3 GetJumpVelocity(float yVelocity)
	{
