...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    public bool GetJumpInputDown()
    {
        if (CanProcessInput())
        {
            bool jumped = Input.GetButtonDown(GameConstants.k_ButtonNameJump) ? true : Input.GetAxis("Mouse ScrollWheel") != 0f;
            return jumped;
        }
    ...
    public bool GetWalkInputHeld()
    {
        if (CanProcessInput())
        {
            return Input.GetButton(GameConstants.k_ButtonNameWalk);
        }
    ...
    public int GetSwitchWeaponInput()
    {
        if (CanProcessInput())
        {
            ...
            string axisName = GameConstants.k_ButtonNameGamepadSwitchWeapon;
