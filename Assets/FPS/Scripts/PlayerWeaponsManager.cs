...
public class PlayerWeaponsManager : MonoBehaviour
{
    ...
    void UpdateWeaponBob()
    {
        if (Time.deltaTime > 0f)
        {
            ...
            {
                characterMovementFactor = Mathf.Clamp01(playerCharacterVelocity.magnitude / (m_PlayerCharacterController.maxSpeed * m_PlayerCharacterController.walkSpeedModifier));
            }
